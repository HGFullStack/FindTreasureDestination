...
public class TeamMovementProcessTest {
  ...
  private static final String INPUT_FILE_PATH_THREE = Constants.INPUT_FILE_NAME_THREE;
  ...
  private static final String OUTPUT_THREE = "1.0 miles to the North, 1.0 miles to the East";
  ...
  @Test
  void testProcess_three() {
    final TeamMovementProcess teamMovementProcess = new TeamMovementProcess();

    assertEquals(OUTPUT_THREE, teamMovementProcess.process(INPUT_FILE_PATH_THREE));
  }
